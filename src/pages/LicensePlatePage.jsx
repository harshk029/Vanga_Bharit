...
export default function LicensePlatePage() {
  ...
  const handleClearPlates = async () => {
    try {
      await fetch('/api/plates/clear', { method: 'DELETE' });
      setPlates({});
      setTotalCount(0);
      setActiveId(null);
    } catch (e) {
      console.error('Failed to clear plates', e);
    }
  };
        ...
        <div className="lpp-panel lpp-panel--video">
          <div className="lpp-panel-hdr">
            ...
            <div className="lpp-hdr-actions">
              ...
              <button className="lpp-reload-btn" onClick={handleClearPlates} title="Clear Plate History">
